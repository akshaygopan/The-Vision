      ...
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
            ...
            Row(
              children: <Widget>[
                ItemCard('assets/images/blue.jpg', 'Pop'),
                SizedBox(
                  width: 16.0,
                ),
                ItemCard('assets/images/pink.jpg', 'Rock'),
              ],
            ),
            SizedBox(
              height: 32.0,
            ...
            Row(
              children: <Widget>[
                ItemCard('assets/images/orange.jpg', 'Band'),
                SizedBox(
                  width: 16.0,
                ),
                ItemCard('assets/images/yellow.jpg', 'Vintage'),
              ],
            ),
            SizedBox(
              height: 32.0,
                ...
                Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                        colors: [black.withOpacity(0.4), black],
